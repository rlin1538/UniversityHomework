...
static struct {
  ...
  {"x","x N EXPR: Take the EXPR as the starting memory address, output n consecutive 4 bytes in hexadecimal form",cmd_x},
  {"p","p EXPR: Expression solving",cmd_p},
  {"w", "w EXPR: Add watchpoint about EXPR",cmd_w},
