...
public class HtmlEmail extends MultiPartEmail
{
     ...
     * or empty; also see {@link MimeBodyPart} for definitions
     *
     ...
     * used; also see {@link MimeBodyPart} for definitions
     *
     ...
     * the value returned by {@link File#getName()}. If the same file
     ...
     *  also see {@link MimeBodyPart} for definitions
     * @since 1.1
     */
